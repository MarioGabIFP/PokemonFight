...
import static view.elements.screen.IMaps.g_0;
...
public class Alabastia_4_3 extends Frame implements Updater {
    ...
    public Alabastia_4_3() throws IOException, SAXException, ParserConfigurationException, InterruptedException {
        ...
        frame.addKeyListener(new Orchestrator(Orchestrator.ObjectTC.player));
        frame.addWindowFocusListener(new Orchestrator(Orchestrator.ObjectTC.player));
