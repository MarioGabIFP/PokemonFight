 ...
 */
public class Menu extends Frame implements Updater {
    String title;
    Orchestrator ma;
    
    public Menu(MenInfo typeMenu) throws IOException, SAXException, ParserConfigurationException, InterruptedException {
